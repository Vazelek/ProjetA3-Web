...
def reducDim(df):
    ...
    df_reduced = df.drop(columns=[ 'num_veh', 'id_code_insee', 'Num_Acc','id_usa', 'place', 'descr_agglo', 'descr_cat_veh', 'an_nais', 'descr_motif_traj', 'description_intersection', 'descr_type_col', 'ville', 'date', 'hour'])
...
if len(sys.argv) != 9:
    ...
    print("\t>>> python script2_sup.py <latitude> <longitude> <descre_athmo> <descr_lum> <descr_etat_surf> <age> <descr_dispo_secu> <filename>")
    print("")
...
if data_csv["latitude"][0] < -90 or data_csv["latitude"][0] > 90 or \
        ...
        data_csv["age"][0] < 0 or \
        data_csv["descr_dispo_secu"][0] < 1 or data_csv["descr_dispo_secu"][0] > 15:
